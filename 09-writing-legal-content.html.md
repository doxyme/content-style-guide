...
The way we write, review, and publish legal content is different than how we do many other kinds of writing at doxy.me. The most important difference is that all legal content either starts with or passes through the legal team.

But that doesn't mean legal content has to be difficult to read. We try to present our legal information in the most pleasant way possible. Our goals for doxy.me's legal content are:
...
These policies apply to all of doxy.me’s users. The legal and communication teams work together to make them as transparent and easy to read as possible. When someone signs up to use doxy.me, they must agree to all of those terms.
...
- doxy.me is owned and operated by The Rocket Science Group, LLC d/b/a doxy.me, a Georgia limited liability corporation (“doxy.me,” “we,” or “us”). As a user of the Service or a representative of an entity that’s a user of the Service, you're a “Member” according to this agreement (or “you”).
...
While we want to inform our users about legal issues related to their use of doxy.me, we can’t offer them legal advice. Sometimes it’s a fine line. The legal department will check for this in their content review.
